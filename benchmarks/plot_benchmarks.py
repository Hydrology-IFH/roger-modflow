...
axes[0].set_yscale('log')
axes[0].legend(frameon=False, fontsize=9)
axes[1].set_ylabel('Computation time per 30 daily time steps [seconds]')
...
axes[1].set_ylabel('Computation time per 30 daily time steps [minutes]')
axes[1].set_xscale('log')
axes[1].legend(frameon=False, fontsize=9)
...
axes.plot(df_roger_numpy["ncells"], time1 - time2, ls="-", marker="o", color="black", lw=1)
axes.set_xscale('log')
...
time2 = df_roger_jax_modflow["time"]/60
axes.plot(df_roger_numpy["ncells"], (time1 / time2), ls="-", marker="o", color="black", lw=1)
axes[1].set_ylabel('Computational difference per 30 daily time steps [-]')
axes.set_xscale('log')
fig.tight_layout()
