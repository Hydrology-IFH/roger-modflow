...
def main():
    ...
    df_params.loc[:, "ta_offset"] = ds_params.F_t.values.T.flatten()
    df_params.loc[:, "pet_weight"] = ds_params.F_et.values.T.flatten() / 100
    df_params.loc[:, "prec_weight"] = ds_params.F_n_h_y.values.T.flatten() / 100
