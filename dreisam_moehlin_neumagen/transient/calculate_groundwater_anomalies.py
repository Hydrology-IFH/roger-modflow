...
fig.colorbar(cbar, ax=ax, label="Average Groundwater Depth [m]", shrink=0.7)
...
ax.set_ylabel('Groundwater Depth [m]', fontsize=12)
ax.set_ylim(0, )
...
ax.hlines(0, anomalies_gw_depths.index[0], anomalies_gw_depths.index[-1], colors='gray', linestyles='dashed')
...
ax.set_xlabel('Time', fontsize=12)
ax.set_ylabel('Groundwater Depth Anomaly [%]', fontsize=12)
...
ax.hlines(0, anomalies_gw_heads_m.index[0], anomalies_gw_heads_m.index[-1], colors='gray', linestyles='dashed')
# fill area between percentiles 25 and 75
...
ax.set_xlabel('Time', fontsize=12)
ax.set_ylabel('Groundwater Head Anomaly [m]', fontsize=12)
...
ax.hlines(0, anomalies_gw_depths_2013_2023.index[0], anomalies_gw_depths_2013_2023.index[-1], colors='gray', linestyles='dashed')
# fill area between percentiles 25 and 75
...
ax.hlines(0, anomalies_gw_heads_m_2013_2023.index[0], anomalies_gw_heads_m_2013_2023.index[-1], colors='gray', linestyles='dashed')
# fill area between percentiles 25 and 75
...
fig, ax = plt.subplots(1, 1, figsize=(10, 6))
anomalies_gw_depths_2013_2017 = anomalies_gw_depths.loc['2013-01-01':'2017-12-31']
ax.plot(anomalies_gw_depths_2013_2017.index, anomalies_gw_depths_2013_2017.median(axis=1), label='Median Anomaly', color='black')
ax.hlines(0, anomalies_gw_depths_2013_2023.index[0], anomalies_gw_depths_2013_2023.index[-1], colors='gray', linestyles='dashed')
# fill area between percentiles 25 and 75
ax.fill_between(anomalies_gw_depths_2013_2017.index,
                anomalies_gw_depths_2013_2017.quantile(0.25, axis=1),
                anomalies_gw_depths_2013_2017.quantile(0.75, axis=1),
                color='gray', alpha=0.75, label='25-75 Percentile Range')
# fill area between percentiles 5 and 95
ax.fill_between(anomalies_gw_depths_2013_2017.index,
                anomalies_gw_depths_2013_2017.quantile(0.05, axis=1),
                anomalies_gw_depths_2013_2017.quantile(0.95, axis=1),
                color='lightgray', alpha=0.5, label='5-95 Percentile Range')
# fill area between percentiles 1 and 99
ax.fill_between(anomalies_gw_depths_2013_2017.index,
                anomalies_gw_depths_2013_2017.quantile(0.01, axis=1),
                anomalies_gw_depths_2013_2017.quantile(0.99, axis=1),
                color='lightgray', alpha=0.25, label='1-99 Percentile Range')
# format x-axis and use %y-%m format
ax.xaxis.set_major_formatter(plt.matplotlib.dates.DateFormatter('%Y-%m'))
ax.set_ylim([-100, 100])
ax.set_xlim([anomalies_gw_depths_2013_2017.index[0], anomalies_gw_depths_2013_2017.index[-1]])
ax.set_xlabel('Time', fontsize=12)
ax.set_ylabel('Groundwater Depth Anomaly [%]', fontsize=12)
file = output_folder / "gw_depth_anomalies_wells_2013_2017.png"
fig.savefig(file)
plt.close(fig)

fig, ax = plt.subplots(1, 1, figsize=(10, 6))
anomalies_gw_heads_m_2013_2017 = anomalies_gw_heads_m.loc['2013-01-01':'2017-12-31']
ax.plot(anomalies_gw_heads_m_2013_2017.index, anomalies_gw_heads_m_2013_2017.median(axis=1), label='Median Anomaly', color='black')
ax.hlines(0, anomalies_gw_heads_m_2013_2017.index[0], anomalies_gw_heads_m_2013_2017.index[-1], colors='gray', linestyles='dashed')
# fill area between percentiles 25 and 75
ax.fill_between(anomalies_gw_heads_m_2013_2017.index,
                anomalies_gw_heads_m_2013_2017.quantile(0.25, axis=1),
                anomalies_gw_heads_m_2013_2017.quantile(0.75, axis=1),
                color='gray', alpha=0.75, label='25-75 Percentile Range')
# fill area between percentiles 5 and 95
ax.fill_between(anomalies_gw_heads_m_2013_2017.index,
                anomalies_gw_heads_m_2013_2017.quantile(0.05, axis=1),
                anomalies_gw_heads_m_2013_2017.quantile(0.95, axis=1),
                color='lightgray', alpha=0.5, label='5-95 Percentile Range')
# fill area between percentiles 1 and 99
ax.fill_between(anomalies_gw_heads_m_2013_2017.index,
                anomalies_gw_heads_m_2013_2017.quantile(0.01, axis=1),
                anomalies_gw_heads_m_2013_2017.quantile(0.99, axis=1),
                color='lightgray', alpha=0.25, label='1-99 Percentile Range')
# format x-axis and use %y-%m format
ax.xaxis.set_major_formatter(plt.matplotlib.dates.DateFormatter('%Y-%m'))
ax.set_ylim([-5, 5])
ax.set_xlim([anomalies_gw_heads_m_2013_2017.index[0], anomalies_gw_heads_m_2013_2017.index[-1]])
ax.set_xlabel('Time', fontsize=12)
ax.set_ylabel('Groundwater Head Anomaly [m]', fontsize=12)
file = output_folder / "gw_head_anomalies_wells_m_2013_2017.png"
fig.savefig(file)
plt.close(fig)
...
for year in range(anomalies_gw_depths.index.year.min(), anomalies_gw_depths.index.year.max() + 1):
    ...
    ax.hlines(0, df_year.index[0], df_year.index[-1], colors='gray', linestyles='dashed')
    # fill area between percentiles 25 and 75
...
fig.colorbar(ax.images[0], ax=ax, label="Variance [m²]")
ax.set_xlabel('x-coordinate', fontsize=12)
ax.set_ylabel('y-coordinate', fontsize=12)
...
ax.scatter(df_drinking_water_wells['x-coordinate'], df_drinking_water_wells['y-coordinate'], c='magenta', s=20, marker='^', label='Drinking Water Well')
ax.legend(loc='lower right', fontsize=12, facecolor='white', edgecolor='white')
fig.colorbar(ax.images[0], ax=ax, label="Average Groundwater Depth [m]")
ax.set_xlabel('x-coordinate', fontsize=12)
ax.set_ylabel('y-coordinate', fontsize=12)
ax.grid(True, alpha=0.3)
ax.axis('equal')
...
for i, time in enumerate(dates):
    if i > (12 * 23) - 1:
        ...
        ax.scatter(df_drinking_water_wells['x-coordinate'], df_drinking_water_wells['y-coordinate'], c='magenta', s=20, marker='^', label='Drinking Water Well')
        ax.legend(loc='lower right', fontsize=12, facecolor='white', edgecolor='white')
        fig.colorbar(ax.images[0], ax=ax, label="Groundwater Depth Anomaly [%]")
        ax.set_xlabel('x-coordinate', fontsize=12)
        ax.set_ylabel('y-coordinate', fontsize=12)
        ax.grid(True, alpha=0.3)
        ax.axis('equal')
        ...
        ax.scatter(df_drinking_water_wells['x-coordinate'], df_drinking_water_wells['y-coordinate'], c='magenta', s=20, marker='^', label='Drinking Water Well')
        ax.legend(loc='lower right', fontsize=12, facecolor='white', edgecolor='white')
        fig.colorbar(ax.images[0], ax=ax, label="Groundwater Head Anomaly [m]")
        ax.set_xlabel('x-coordinate', fontsize=12)
        ax.set_ylabel('y-coordinate', fontsize=12)
        ax.grid(True, alpha=0.3)
        ax.axis('equal')
        ...
        ax.scatter(df_drinking_water_wells['x-coordinate'], df_drinking_water_wells['y-coordinate'], c='magenta', s=20, marker='^', label='Drinking Water Well')
        ax.legend(loc='lower right', fontsize=12, facecolor='white', edgecolor='white')
        fig.colorbar(ax.images[0], ax=ax, label="Groundwater Depth [m]")
        ax.set_xlabel('x-coordinate', fontsize=12)
        ax.set_ylabel('y-coordinate', fontsize=12)
        ax.grid(True, alpha=0.3)
        ax.axis('equal')
