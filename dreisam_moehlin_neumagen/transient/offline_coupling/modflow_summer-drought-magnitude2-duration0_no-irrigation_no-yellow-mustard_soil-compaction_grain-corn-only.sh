...
tar -xf ${TMPDIR}/roger-modflow/dreisam_moehlin_neumagen/transient/input/ONEDCROP_rci_summer-drought-magnitude2-duration0_no-irrigation_no-yellow-mustard_soil-compaction_grain-corn-only.tar.gz -C ${TMPDIR}/roger-modflow/dreisam_moehlin_neumagen/transient/input/
sleep 160
