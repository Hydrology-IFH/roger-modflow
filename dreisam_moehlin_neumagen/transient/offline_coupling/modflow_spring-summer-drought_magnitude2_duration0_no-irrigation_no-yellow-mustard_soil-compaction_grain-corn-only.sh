...
echo "Move output to /pfs/10/work/fr_rs1092-workspace/roger-modflow/dreisam_moehlin_neumagen/transient/offline_coupling/output/modflow_spring-summer-drought_magnitude2_duration0_no-irrigation_no-yellow-mustard_soil-compaction_grain-corn-only"
mkdir -p /pfs/10/work/fr_rs1092-workspace/roger-modflow/dreisam_moehlin_neumagen/transient/offline_coupling/output/modflow_spring-summer-drought_magnitude2_duration0_no-irrigation_no-yellow-mustard_soil-compaction_grain-corn-only
