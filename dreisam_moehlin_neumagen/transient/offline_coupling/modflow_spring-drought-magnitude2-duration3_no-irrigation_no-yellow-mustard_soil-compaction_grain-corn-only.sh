...
tar -xf ${TMPDIR}/roger-modflow/dreisam_moehlin_neumagen/transient/input/ONEDCROP_rci_spring-drought-magnitude2-duration3_no-irrigation_no-yellow-mustard_soil-compaction_grain-corn-only.tar.gz -C ${TMPDIR}/roger-modflow/dreisam_moehlin_neumagen/transient/input/
sleep 160
