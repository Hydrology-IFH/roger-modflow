...
class ModFlowSimulation:
    def __init__(
        ...
        hydraulic_conductivities_layer1 = hydraulic_conductivities_layer1 * fudge_parameters['c'].values[model_run]
        hydraulic_conductivities_layer2 = hydraulic_conductivities_layer2 * fudge_parameters['c'].values[model_run]
        hydraulic_conductivities_layer3 = hydraulic_conductivities_layer3 * fudge_parameters['c'].values[model_run]
        hydraulic_conductivities_layer4 = hydraulic_conductivities_layer4 * fudge_parameters['c'].values[model_run]
