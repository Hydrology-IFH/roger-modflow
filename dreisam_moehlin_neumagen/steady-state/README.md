...
## Topography
A 50 m x 50 m digital elevation model is used to describe the surface topography. A 5 m x 5 m digital elevation model is used to describe the riverbed. topography
