...
7. Assign the hydraulic conductivity of the streambed and Manning's coeffecient to the SFR packagedata.
8. Identify the diversions (i.e. river reaches with with downstream connections).
9. Identify the reach IDs to collect the water depth and downstream flow.
