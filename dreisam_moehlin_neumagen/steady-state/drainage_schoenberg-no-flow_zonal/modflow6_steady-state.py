...
class ModFlowSimulation:
    def __init__(
        ...
        # fudge parameters for hydraulic conductivities in zone 1
        ...
        mask1341 = (hydraulic_conductivities_layer4_ == 1.0000000e-03) & (topography < 300)
        ...
        mask3341 = (hydraulic_conductivities_layer4_ == 3.0000000e-03) & (topography < 300)
        ...
        mask4341 = (hydraulic_conductivities_layer4_ == 4.0000002e-03) & (topography < 300)
        ...
        mask1342 = (hydraulic_conductivities_layer4_ == 1.0000000e-03) & (topography >= 300)
        ...
        mask3342 = (hydraulic_conductivities_layer4_ == 3.0000000e-03) & (topography >= 300)
        ...
        mask4342 = (hydraulic_conductivities_layer4_ == 4.0000002e-03) & (topography >= 300)

        # fudge parameters in zone 1
        hydraulic_conductivities_layer1[mask811] = hydraulic_conductivities_layer1[mask811] * fudge_parameters['-8_1'].values[model_run]

        hydraulic_conductivities_layer1[mask711] = hydraulic_conductivities_layer1[mask711] * fudge_parameters['-7_1'].values[model_run]
        hydraulic_conductivities_layer2[mask721] = hydraulic_conductivities_layer2[mask721] * fudge_parameters['-7_1'].values[model_run]
        hydraulic_conductivities_layer3[mask731] = hydraulic_conductivities_layer3[mask731] * fudge_parameters['-7_1'].values[model_run] * 0.666
        hydraulic_conductivities_layer4[mask741] = hydraulic_conductivities_layer4[mask741] * fudge_parameters['-7_1'].values[model_run] * 0.333

        hydraulic_conductivities_layer1[mask611] = hydraulic_conductivities_layer1[mask611] * fudge_parameters['-6_1'].values[model_run]

        hydraulic_conductivities_layer1[mask511] = hydraulic_conductivities_layer1[mask511] * fudge_parameters['-5_1'].values[model_run]
        hydraulic_conductivities_layer2[mask521] = hydraulic_conductivities_layer2[mask521] * fudge_parameters['-5_1'].values[model_run]
        hydraulic_conductivities_layer3[mask531] = hydraulic_conductivities_layer3[mask531] * fudge_parameters['-5_1'].values[model_run]
        hydraulic_conductivities_layer4[mask541] = hydraulic_conductivities_layer4[mask541] * fudge_parameters['-5_1'].values[model_run]

        hydraulic_conductivities_layer2[mask421] = hydraulic_conductivities_layer2[mask421] * fudge_parameters['-4_1'].values[model_run]
        hydraulic_conductivities_layer3[mask431] = hydraulic_conductivities_layer3[mask431] * fudge_parameters['-4_1'].values[model_run]
        hydraulic_conductivities_layer4[mask441] = hydraulic_conductivities_layer4[mask441] * fudge_parameters['-4_1'].values[model_run]

        hydraulic_conductivities_layer2[mask1321] = hydraulic_conductivities_layer2[mask1321] * fudge_parameters['1-3_1'].values[model_run]
        hydraulic_conductivities_layer3[mask1331] = hydraulic_conductivities_layer3[mask1331] * fudge_parameters['1-3_1'].values[model_run]
        hydraulic_conductivities_layer4[mask1341] = hydraulic_conductivities_layer4[mask1341] * fudge_parameters['1-3_1'].values[model_run]

        hydraulic_conductivities_layer2[mask2321] = hydraulic_conductivities_layer2[mask2321] * fudge_parameters['1.8-3_1'].values[model_run]
        hydraulic_conductivities_layer3[mask2331] = hydraulic_conductivities_layer3[mask2331] * fudge_parameters['1.8-3_1'].values[model_run]
        hydraulic_conductivities_layer4[mask2341] = hydraulic_conductivities_layer4[mask2341] * fudge_parameters['1.8-3_1'].values[model_run]

        hydraulic_conductivities_layer2[mask3321] = hydraulic_conductivities_layer2[mask3321] * fudge_parameters['3-3_1'].values[model_run]
        hydraulic_conductivities_layer3[mask3331] = hydraulic_conductivities_layer3[mask3331] * fudge_parameters['3-3_1'].values[model_run]
        hydraulic_conductivities_layer4[mask3341] = hydraulic_conductivities_layer4[mask3341] * fudge_parameters['3-3_1'].values[model_run]

        hydraulic_conductivities_layer2[mask4321] = hydraulic_conductivities_layer2[mask4321] * fudge_parameters['4-3_1'].values[model_run]
        hydraulic_conductivities_layer3[mask4331] = hydraulic_conductivities_layer3[mask4331] * fudge_parameters['4-3_1'].values[model_run]
        hydraulic_conductivities_layer4[mask4341] = hydraulic_conductivities_layer4[mask4341] * fudge_parameters['4-3_1'].values[model_run]

        # fudge parameters in zone 2
        hydraulic_conductivities_layer1[mask812] = hydraulic_conductivities_layer1[mask812] * fudge_parameters['-8_2'].values[model_run]

        hydraulic_conductivities_layer1[mask712] = hydraulic_conductivities_layer1[mask712] * fudge_parameters['-7_2'].values[model_run]
        hydraulic_conductivities_layer2[mask722] = hydraulic_conductivities_layer2[mask722] * fudge_parameters['-7_2'].values[model_run]
        hydraulic_conductivities_layer3[mask732] = hydraulic_conductivities_layer3[mask732] * fudge_parameters['-7_2'].values[model_run] * 0.666
        hydraulic_conductivities_layer4[mask742] = hydraulic_conductivities_layer4[mask742] * fudge_parameters['-7_2'].values[model_run] * 0.333

        hydraulic_conductivities_layer1[mask612] = hydraulic_conductivities_layer1[mask612] * fudge_parameters['-6_2'].values[model_run]

        hydraulic_conductivities_layer1[mask512] = hydraulic_conductivities_layer1[mask512] * fudge_parameters['-5_2'].values[model_run]
        hydraulic_conductivities_layer2[mask522] = hydraulic_conductivities_layer2[mask522] * fudge_parameters['-5_2'].values[model_run]
        hydraulic_conductivities_layer3[mask532] = hydraulic_conductivities_layer3[mask532] * fudge_parameters['-5_2'].values[model_run]
        hydraulic_conductivities_layer4[mask542] = hydraulic_conductivities_layer4[mask542] * fudge_parameters['-5_2'].values[model_run]

        hydraulic_conductivities_layer2[mask422] = hydraulic_conductivities_layer2[mask422] * fudge_parameters['-4_2'].values[model_run]
        hydraulic_conductivities_layer3[mask432] = hydraulic_conductivities_layer3[mask432] * fudge_parameters['-4_2'].values[model_run]
        hydraulic_conductivities_layer4[mask442] = hydraulic_conductivities_layer4[mask442] * fudge_parameters['-4_2'].values[model_run]

        hydraulic_conductivities_layer2[mask1322] = hydraulic_conductivities_layer2[mask1322] * fudge_parameters['1-3_2'].values[model_run]
        hydraulic_conductivities_layer3[mask1332] = hydraulic_conductivities_layer3[mask1332] * fudge_parameters['1-3_2'].values[model_run]
        hydraulic_conductivities_layer4[mask1342] = hydraulic_conductivities_layer4[mask1342] * fudge_parameters['1-3_2'].values[model_run]

        hydraulic_conductivities_layer2[mask2322] = hydraulic_conductivities_layer2[mask2322] * fudge_parameters['1.8-3_2'].values[model_run]
        hydraulic_conductivities_layer3[mask2332] = hydraulic_conductivities_layer3[mask2332] * fudge_parameters['1.8-3_2'].values[model_run]
        hydraulic_conductivities_layer4[mask2342] = hydraulic_conductivities_layer4[mask2342] * fudge_parameters['1.8-3_2'].values[model_run]

        hydraulic_conductivities_layer2[mask3322] = hydraulic_conductivities_layer2[mask3322] * fudge_parameters['3-3_2'].values[model_run]
        hydraulic_conductivities_layer3[mask3332] = hydraulic_conductivities_layer3[mask3332] * fudge_parameters['3-3_2'].values[model_run]
        hydraulic_conductivities_layer4[mask3342] = hydraulic_conductivities_layer4[mask3342] * fudge_parameters['3-3_2'].values[model_run]

        hydraulic_conductivities_layer2[mask4322] = hydraulic_conductivities_layer2[mask4322] * fudge_parameters['4-3_2'].values[model_run]
        hydraulic_conductivities_layer3[mask4332] = hydraulic_conductivities_layer3[mask4332] * fudge_parameters['4-3_2'].values[model_run]
        hydraulic_conductivities_layer4[mask4342] = hydraulic_conductivities_layer4[mask4342] * fudge_parameters['4-3_2'].values[model_run]    
...
def main(model_run):
    ...
    fudge_parameters.columns = [
        ["[-]", "[-]", "[-]", "[-]", "[-]", "[-]", "[-]", "[-]", "[-]", 
         "[-]", "[-]", "[-]", "[-]", "[-]", "[-]", "[-]", "[-]", "[-]", 
         "[-]", "[m]",  ""],
        ["-8_1", "-7_1", "-6_1", "-5_1", "-4_1", "1-3_1", "1.8-3_1", "3-3_1", "4-3_1",
         "-8_2", "-7_2", "-6_2", "-5_2", "-4_2", "1-3_2", "1.8-3_2", "3-3_2", "4-3_2", 
         "rch", "offset", "complete"],
    ]
