...
def main(model_run):
    ...
    ll_levels = [[280, 290, 300, 310, 320, 325, 330, 340],
                 [280, 290, 300, 310, 320, 325, 330, 340],
                 [280, 290, 300, 310, 320, 325, 330, 340],
                 [280, 290, 300, 310, 320, 325, 330, 340]]
    ...
    for layer in range(4):
        ...
        gw_depth = gw_depth[ylim1:ylim2, xlim1:xlim2]
        fig, axes = plt.subplots(figsize=(4, 4))
        ...
        thickness = thickness[ylim1:ylim2, xlim1:xlim2]
        fig, axes = plt.subplots(figsize=(4, 4))
        ...
        hydraulic_conductivity = hydraulic_conductivity[ylim1:ylim2, xlim1:xlim2]
        fig, axes = plt.subplots(figsize=(4, 4))
