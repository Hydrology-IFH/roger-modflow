...
class ModFlowSimulation:
    def __init__(
        ...
        mask = np.where(mask_boundary_condition_black_forest, True, mask)
        ...
        hydraulic_conductivities_layer1 = hydraulic_conductivities_layer1 * fudge_parameters['l_1'].values[model_run]
