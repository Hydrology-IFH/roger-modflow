...
def main(offset, plot):
    ...
    mask_boundary_condition_black_forest = np.where(mask_schoenberg, np.nan, mask_boundary_condition_black_forest)
    ...
    constant_head_depth_black_forest = _topography - black_forest
    constant_head_black_forest[constant_head_depth_black_forest < 1] = _topography[constant_head_black_forest < 1] - 1
