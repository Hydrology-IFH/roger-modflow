...
class ModFlowSimulation:
    def __init__(
        ...
        hydraulic_conductivities_layer2[mask2] = hydraulic_conductivities_layer2[mask2] * fudge_parameters['rz10_23'].values[model_run] * 0.15
        hydraulic_conductivities_layer3[mask3] = hydraulic_conductivities_layer3[mask3] * fudge_parameters['rz10_23'].values[model_run] * 0.15
        hydraulic_conductivities_layer4[mask4] = hydraulic_conductivities_layer4[mask4] * fudge_parameters['r10_4'].values[model_run] * 0.15
