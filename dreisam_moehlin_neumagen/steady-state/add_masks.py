...
with h5netcdf.File(path, "a", decode_vlen_strings=False) as f:
    ...
    try:
        ...
        v.attrs.update(long_name="Mask of gravel areas (Brugga)", units="")
    except ValueError:
    ...
    try:
        ...
        v.attrs.update(long_name="Mask of gravel areas (Zarten basin)", units="")
    except ValueError:
    ...
    try:
        ...
        v.attrs.update(long_name="Mask of gravel areas (Staufen)", units="")
    except ValueError:
