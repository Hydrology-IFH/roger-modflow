...
python modflow6_steady-state.py --model-run 2076
python write_binary_to_netcdf_steady-state.py --model-run 2076
python plot_groundwater_heads_steady-state.py --model-run 2076
python evaluate_steady-state_simulation.py --model-run 2076
