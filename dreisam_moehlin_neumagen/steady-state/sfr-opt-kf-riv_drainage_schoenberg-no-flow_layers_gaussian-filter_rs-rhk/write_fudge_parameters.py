...
def main(nsamples):
    ...
    df_params.loc[:33, "-7_2"] = 3.2
    df_params.loc[:33, "-7_3"] = 3.1
    df_params.loc[:33, "-7_4"] = 3.0

    df_params.loc[:33, "1.8-3_2"] = 0.9 
    df_params.loc[:33, "3-3_2"] = 5.5 
    df_params.loc[:33, "4-3_2"] = 1.5
    df_params.loc[:33, "1.8-3_3"] = 0.9
    ...
    df_params.loc[30, "rhkp"] = 1.0
    df_params.loc[31, "rhkp"] = 1.0
    df_params.loc[32, "rhkp"] = 1.0
    df_params.loc[33, "rhkp"] = 1.0
    df_params.loc[30, "rhkp"] = 1.0
    df_params.loc[31, "rhkp"] = 1.0
    df_params.loc[32, "rhkp"] = 1.0
    ...
    df_params = df_params.loc[:, ["-8_1", "-7_1", "-6_1", "-5_1", 
                                  ...
                                  "-7_4", "-5_4","-4_4", "1.8-3_4",
                                  "kf_riv", "rhkp", "rhkf", "rhk_scale", "rhk_shape", "man",
                                  "rch", "offset"]]
