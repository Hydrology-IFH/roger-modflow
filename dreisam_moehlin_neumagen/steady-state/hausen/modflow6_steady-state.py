...
class ModFlowSimulation:
    def __init__(
        ...
        hydraulic_conductivities_layer2 = ds_params['kf'].isel(layer=1).values * 1.2
        hydraulic_conductivities_layer3 = ds_params['kf'].isel(layer=2).values * 1.2
        hydraulic_conductivities_layer4 = ds_params['kf'].isel(layer=3).values * 1.2
        ...
        # hydraulic_conductivities_layer1 = hydraulic_conductivities_layer1 * 2
        ...
        # hydraulic_conductivities_layer2[mask14] = hydraulic_conductivities_layer2[mask14] * fudge_parameters['m0011'].values[model_run] * 2
        # hydraulic_conductivities_layer3[mask15] = hydraulic_conductivities_layer3[mask15] * fudge_parameters['m0011'].values[model_run] * 2
        # hydraulic_conductivities_layer4[mask16] = hydraulic_conductivities_layer4[mask16] * fudge_parameters['m0011'].values[model_run] * 2
        ...
        for ii in range(0, len(rows_bc)):
            constant_head = ds_bc['constant_head_porous_aquifer'].values[rows_bc[ii], cols_bc[ii]] - 3
        ...
        wells_q = [5727, 5822, 3494, 4315, 4525, 2899]
        # location of the wells
        wells_y = [266, 268, 271, 272, 280, 259, 210]
        wells_x = [66, 64, 63, 59, 56, 88]
        wel_rec = []
