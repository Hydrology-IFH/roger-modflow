...
for i in range(10):
    ...
    shutil.copy(base_path / "modflow6_steady-state_rerun_.py", path_dir / "modflow6_steady-state_rerun_.py")
...
for j in range(10):
    ...
    lines.append("\tconverged=$(python modflow6_steady-state_rerun.py --model-run $i --converged $converged | grep 'converged: ' | awk '{print $NF}')\n")
    lines.append("\tpython write_binary_to_netcdf_steady-state.py --model-run $i --converged $converged\n")
