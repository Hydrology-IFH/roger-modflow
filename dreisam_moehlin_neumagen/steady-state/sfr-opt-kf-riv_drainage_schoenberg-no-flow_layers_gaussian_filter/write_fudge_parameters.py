...
def main(nsamples):
    ...
    df_params.loc[30, "rhk"] = 90e-4
    df_params.loc[31, "rhk"] = 95e-4
    df_params.loc[32, "rhk"] = 15e-3
    df_params.loc[33, "rhk"] = 20e-3
