...
#SBATCH --job-name=sfr-opt-kf-riv_drainage_schoenberg-no-flow_layers_gaussian-filter_5
#SBATCH --output=sfr-opt-kf-riv_drainage_schoenberg-no-flow_layers_gaussian-filter_5.out
#SBATCH --error=sfr-opt-kf-riv_drainage_schoenberg-no-flow_layers_gaussian-filter_5_err.out
#SBATCH --export=ALL
