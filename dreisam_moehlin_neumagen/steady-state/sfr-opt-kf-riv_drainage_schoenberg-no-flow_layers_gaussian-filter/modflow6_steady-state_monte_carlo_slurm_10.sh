...
#SBATCH --job-name=sfr-opt-kf-riv_drainage_schoenberg-no-flow_layers_gaussian-filter_10
#SBATCH --output=sfr-opt-kf-riv_drainage_schoenberg-no-flow_layers_gaussian-filter_10.out
#SBATCH --error=sfr-opt-kf-riv_drainage_schoenberg-no-flow_layers_gaussian-filter_10_err.out
#SBATCH --export=ALL
