...
#SBATCH --job-name=sfr-opt-kf-riv_drainage_schoenberg-no-flow_layers_gaussian-filter_8
#SBATCH --output=sfr-opt-kf-riv_drainage_schoenberg-no-flow_layers_gaussian-filter_8.out
#SBATCH --error=sfr-opt-kf-riv_drainage_schoenberg-no-flow_layers_gaussian-filter_8_err.out
#SBATCH --export=ALL
