...
def main(nsamples):
    ...
    df_params["offset"] = 0.
    df_params.iloc[:34, :] = 1.
    df_params.loc[:33, "kf_riv"] = 1.5
    df_params.loc[:33, "rhk"] = 80.

    xx = 1.2
    df_params.loc[:33, "-8_1"] = 500.
    df_params.loc[:33, "-7_1"] = 40. * xx
    df_params.loc[:33, "-7_2"] = 30. * xx
    df_params.loc[:33, "-7_3"] = 20. * xx
    df_params.loc[:33, "-7_4"] = 15. * xx
