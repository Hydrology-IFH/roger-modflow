...
def main(nsamples):
    ...
    df_params.loc[27, "-8"] = 571
    df_params.loc[27, "-7"] = 11
    df_params.loc[27, "-6"] = 662
    df_params.loc[27, "-5"] = 12.5
    df_params.loc[27, "-4"] = 6.7
    df_params.loc[27, "1-3"] = 1.27
    df_params.loc[27, "1.8-3"] = 0.21
    df_params.loc[27, "3-3"] = 1.25
    df_params.loc[27, "4-3"] = 1.55
    df_params.loc[27, "rch"] = 1.17
    df_params.loc[27, "offset"] = 0.0
    df_params.loc[28, "-8"] = 83
    df_params.loc[28, "-7"] = 531
    df_params.loc[28, "-6"] = 614
    df_params.loc[28, "-5"] = 62
    df_params.loc[28, "-4"] = 1.16
    df_params.loc[28, "1-3"] = 0.91
    df_params.loc[28, "1.8-3"] = 1.89
    df_params.loc[28, "3-3"] = 1.06
    df_params.loc[28, "4-3"] = 0.31
    df_params.loc[28, "rch"] = 1.22
    df_params.loc[28, "offset"] = 0.0
