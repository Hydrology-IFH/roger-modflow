...
with h5netcdf.File(path, "a", decode_vlen_strings=False) as f:
    ...
    elevation_bottom_layer2[elevation_bottom_layer1 <= elevation_bottom_layer2] = elevation_bottom_layer2[elevation_bottom_layer1 <= elevation_bottom_layer2] - 5
    ...
    elevation_bottom_layer3[elevation_bottom_layer2 <= elevation_bottom_layer3] = elevation_bottom_layer3[elevation_bottom_layer2 <= elevation_bottom_layer3] - 5
    ...
    elevation_bottom_layer4[elevation_bottom_layer3 <= elevation_bottom_layer4] = elevation_bottom_layer4[elevation_bottom_layer3 <= elevation_bottom_layer4] - 5 
    elevation_bottom_layer4[elevation_bottom_layer4 <= 100.1] = 0
