...
def main():
    ...
    df_zarten = pd.DataFrame(index=[0], columns=["lateral_inflow", "indirect_recharge", "direct_recharge", "gw_extraction", "streamflow", "gw_loss_to_surface_water", "lateral_outflow"])
