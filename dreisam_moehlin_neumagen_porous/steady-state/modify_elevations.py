...
with h5netcdf.File(path, "a", decode_vlen_strings=False) as f:
    ...
    elevation_bottom_layer4[elevation_bottom_layer4 <= 100.1] = 90
    ...
    # cond = (thickness_layer3 < 25) & (thickness_layer4 > 25)
    # elevation_bottom_layer4[cond] = elevation_bottom_layer3[cond] - (thickness_layer3[cond] * 4)
