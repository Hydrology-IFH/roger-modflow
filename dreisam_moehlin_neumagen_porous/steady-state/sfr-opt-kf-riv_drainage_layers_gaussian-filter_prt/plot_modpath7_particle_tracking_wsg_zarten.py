...
def plot_all_pathlines(grid, heads, mp7pl, wells, figures_dir=base_path_external / "figures"):
    with styles.USGSPlot():
        ...
        fig.tight_layout()
        fig.savefig(figures_dir / "particle_tracking_grid_mp7_wsg_zarten.png", dpi=300)
        ...
        plot_pathlines_grid_zoom(ax1,
            ...
            wells)
        fig1.tight_layout()
        fig1.savefig(figures_dir / "particle_tracking_grid_mp7_wsg_zarten_zoom.png", dpi=300)
        ...
        plot_pathlines_contours(ax2,
            ...
            wells)
        fig2.tight_layout()
        fig2.savefig(figures_dir / "particle_tracking_contours_mp7_wsg_zarten.png", dpi=300)
        ...
        plot_pathlines_contours_zoom(ax3,
            ...
            wells)
        fig3.tight_layout()
        fig3.savefig(figures_dir / "particle_tracking_contours_mp7_wsg_zarten_zoom.png", dpi=300)
