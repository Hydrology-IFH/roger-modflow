...
class ModFlowSimulation:
    def __init__(
        ...
        # cond_ = reaches["line_id"].isin([288, 253, 289, 336, 337, 338, 339, 184])
        # reaches.loc[cond_, "rhk"] = 9*10e-6 * 86400  # set specific streambed conductance for Dreisam reach
    ...
    def step(self):
        ...
        signal.alarm(45)  # Set the timeout duration to 45 seconds
