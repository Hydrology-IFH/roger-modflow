...
## Lateral inflow (Neumann boundary condition or second order boundary condition)
A lateral inflow is set at the boundary to the black forest and Schoenberg. We assigned a no flow boundary to the Schoenberg due to very complex hydrogeologic conditions (e.g. layers of opalinus clay).
...
5. Repair the geometries of the river segments --> `python repair_geometries_of_stream_segments.py`
