...
#SBATCH --job-name=calculate_anomaly_metrics
#SBATCH --output=calculate_anomaly_metrics.out
#SBATCH --error=calculate_anomaly_metrics_err.out
#SBATCH --export=ALL
...
python calculate_anomaly_metrics.py
