...
def main(model_run):
    ...
    for year in years:
        ...
        output_file = base_path_output / f"indirect_recharge_run{model_run}_year{year}.nc"
    ...
    for year in years:
        ...
        output_file = base_path_output / f"recharge_base-magnitude0-duration0_no-irrigation_no-yellow-mustard_soil-compaction_year{year}.nc"
    ...
    df_extraction_balance_monthly["extraction_balance"] = df_drinking_water_well_extraction_monthly["well_extraction"] - ((df_direct_recharge_monthly["direct_recharge"] + df_indirect_recharge_monthly["indirect_recharge"]) * 0.3)
    ...
    df_extraction_balance_annual["extraction_balance"] = df_drinking_water_well_extraction_annual["well_extraction"] - ((df_direct_recharge_annual["direct_recharge"] + df_indirect_recharge_annual["indirect_recharge"]) * 0.3)
