...
#SBATCH --job-name=calculate_annual_anomalies_wsg_march
#SBATCH --output=calculate_annual_anomalies_wsg_march.out
#SBATCH --error=calculate_annual_anomalies_wsg_march_err.out
#SBATCH --export=ALL
