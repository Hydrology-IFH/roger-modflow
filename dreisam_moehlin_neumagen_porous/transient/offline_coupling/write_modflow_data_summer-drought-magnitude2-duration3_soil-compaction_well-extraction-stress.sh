...
#SBATCH --job-name=write_modflow_data_summer-drought-magnitude2-duration3_soil-compaction_well-extraction-stress
#SBATCH --output=write_modflow_data_summer-drought-magnitude2-duration3_soil-compaction_well-extraction-stress.out
#SBATCH --error=write_modflow_data_summer-drought-magnitude2-duration3_soil-compaction_well-extraction-stress_err.out
#SBATCH --export=ALL
