...
#SBATCH --job-name=write_modflow_data_spring-summer-wet_soil-compaction
#SBATCH --output=write_modflow_data_spring-summer-wet_soil-compaction.out
#SBATCH --error=write_modflow_data_spring-summer-wet_soil-compaction_err.out
#SBATCH --export=ALL
